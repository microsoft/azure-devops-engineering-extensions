...
export class TaskInsights {
     ...
     * @param firstTableType Type of information table to create/add to
     * @param secondTableType Optional second type of information table to create/add to
     */
    private async manageComments(firstTableType: string, secondTableType?: string): Promise<void> {
