...
export class BuildTaskRun extends AbstractPipelineTaskRun {
    ...
    constructor(taskRunReference: ITaskReference, name: string, startTime: Date, finishTime: Date, agentName: string, state: azureBuildInterfaces.TimelineRecordState, result: azureBuildInterfaces.TaskResult) {
